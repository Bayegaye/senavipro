...
class Order(db.Model):
    """Commande client en attente : réserve virtuellement un produit pour un
    client avant confirmation en vente réelle (facture) ou annulation. Tant
    qu'elle est en_attente, le stock réel n'est pas débité — seule la
    disponibilité affichée en tient compte, pour éviter la survente."""
